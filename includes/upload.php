...
<div class="modal-overlay" id="dlcModal">
  <div class="modal-box">
    <div class="modal-hdr"><h3 id="dlcMTitle">Add DLC Rate</h3><button class="modal-close" onclick="closeDlcModal()">X</button></div>
...
<div class="login-wrap">
  ...
  <div class="login-card">
    ...
    <div id="forgotForm" style="display:none;margin-top:1rem;padding-top:1rem;border-top:1px solid var(--border)">
      ...
      <form method="POST" action="index.php">
        ...
        <button type="submit" class="btn btn-primary btn-md btn-full">Send Reset Link</button>
      </form>
    </div>
  ...
  <div class="login-card">
    ...
    <?php endif; ?>
    <div style="text-align:center;margin-top:.9rem"><a href="index.php?page=login" style="font-size:.78rem">Back to Sign In</a></div>
  </div>
  <?php endif; ?>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="nav-item <?= $page==='approvals'?'active':'' ?>" href="index.php?page=approvals">
        <span class="ni">[!]</span> Plan Approvals
      ...
      <a class="nav-item <?= $page==='subscriptions'?'active':'' ?>" href="index.php?page=subscriptions"><span class="ni">[$]</span> Users &amp; Subs</a>
      <a class="nav-item <?= $page==='permissions'?'active':'' ?>" href="index.php?page=permissions"><span class="ni">[P]</span> Permissions</a>
  ...
  <div class="main-wrap">
    ...
    <div class="sponsored-strip">
      ...
      <div class="sponsored-strip-grid">
        ...
        <a href="index.php?page=view&id=<?= $sp['id'] ?>" class="sp-card" style="text-decoration:none">
          <div class="sp-thumb"><?php if ($sp['file_type']==='image'&&$sp['file_path']): ?><img src="<?= e($sp['file_path']) ?>" alt=""><?php else: ?><span>[DEV]</span><?php endif; ?></div>
          <div class="sp-body">
            ...
            <div style="font-size:.66rem;color:var(--gold-s);margin-top:3px">&#9733; <?= e($sp['sponsored_label']) ?></div>
          </div>
        </a>
        <?php endforeach; ?>
      </div>
    ...
    <form method="GET" action="index.php">
      ...
      <div class="search-bar">
        ...
        <?php if ($q||$vf||$tf): ?><a href="index.php?page=home&tab=<?= e($tab) ?>" class="btn btn-ghost btn-md">Clear</a><?php endif; ?>
      </div>
    ...
    <?php if (empty($plans)): ?>
    <div style="text-align:center;padding:3rem 1rem;color:var(--t3)"><div style="font-size:2.5rem;margin-bottom:.7rem">?</div><h3 style="margin-bottom:.4rem">No <?= $tab==='developer'?'developer':'' ?> plans<?= ($q||$vf||$tf)?' found':' yet' ?></h3><p style="font-size:.82rem"><?= ($q||$vf||$tf)?'Try a different search.':(is_admin()||is_developer()?'Add the first plan.':'No plans available.') ?></p></div>
    <?php else: ?>
    <div class="plans-grid">
      ...
      <div class="plan-card <?= $isDev?'dev-card':'' ?> <?= $isSpon?'sponsored':'' ?>">
        ...
        <div class="plan-card-body">
          ...
          <?php if ($isDev): ?>
          <div class="plan-dev-badge">[DEV] <?= e($plan['dev_fullname']?:$plan['dev_username']) ?></div>
        ...
        <div class="plan-card-footer">
          ...
          <?php endif; ?>
          <?php if (is_admin()): ?>
          <form method="POST" style="display:inline" onsubmit="return confirm('Delete this plan?')"><input type="hidden" name="action" value="delete_plan"><input type="hidden" name="plan_id" value="<?= $plan['id'] ?>"><input type="hidden" name="csrf_token" value="<?= e($csrfTok) ?>"><button type="submit" class="btn btn-danger btn-sm">Del</button></form>
          <?php endif; ?>
        </div>
      </div>
      <?php endforeach; ?>
        ...
        <form method="POST" action="index.php" enctype="multipart/form-data">
          ...
          <div class="form-grid">
            ...
            <div class="form-field dev-field" id="approvedMapField" style="<?= (!$isDeveloperForm&&!$editIsDev)?'display:none':'' ?>">
              ...
              <div class="upload-zone" style="padding:1rem"><input type="file" name="approved_map" accept="image/*,.pdf"><div style="font-size:1.5rem;margin-bottom:.4rem">[MAP]</div><p style="font-size:.78rem">Upload government approved map</p><small>Max <?= MAX_FILE_MB ?>MB</small></div>
          ...
          <div class="form-field">
            ...
            <?php endif; ?>
            <div class="upload-zone" id="chainZone"><input type="file" name="chain_docs[]" id="chainInput" accept="image/*,.pdf" multiple><div style="font-size:1.5rem;margin-bottom:.4rem">[FILES]</div><p>Click or drag files here</p><small>Multiple files allowed</small></div>
    ...
    <?php if (!$isBasic): ?>
    <div style="max-width:500px;margin:3rem auto;text-align:center"><div class="card"><div class="card-body" style="padding:2.5rem 1.5rem"><div style="font-size:2.5rem;margin-bottom:.8rem">[LOCK]</div><h2 style="margin-bottom:.5rem">Subscription Required</h2><p style="font-size:.84rem;color:var(--t3);margin-bottom:1.2rem">You need an active subscription to view plan details.</p><a href="index.php" class="btn btn-ghost btn-md" style="margin-right:8px">Back</a><a href="index.php?page=profile" class="btn btn-primary btn-md">Request Access</a></div></div></div>
    <?php else: ?>
    ...
    <div style="display:flex;gap:8px;margin-bottom:1.1rem;align-items:center;flex-wrap:wrap">
      ...
      <?php if (is_admin()||$ownDev): ?><a href="index.php?page=edit&id=<?= $plan['id'] ?>" class="btn btn-secondary btn-sm">Edit</a><?php endif; ?>
    ...
    <div class="two-col">
      ...
      <div>
        ...
        <?php if ($hasPricing): ?>
        <div class="card" style="margin-bottom:1.1rem">
          <div class="card-header"><h3>Pricing (per <?= e($plan['price_unit']) ?>)</h3></div>
          <div class="card-body">
            <table style="width:100%;border-collapse:collapse">
        ...
        <div class="card" style="margin-bottom:1.1rem"><div class="card-header"><h3>Brokerage</h3></div><div class="card-body"><div style="font-size:1.2rem;font-weight:700;color:var(--gold-s);margin-bottom:.4rem"><?= number_format((float)$plan['brokerage_rate'],2) ?>%</div><?php if ($plan['brokerage_notes']): ?><p style="font-size:.81rem;color:var(--t2)"><?= e($plan['brokerage_notes']) ?></p><?php endif; ?></div></div>
        <?php endif; ?>
        <?php else: ?>
        ...
        <div class="card" style="margin-bottom:1.1rem"><div class="card-header"><h3>DLC Rates</h3></div><div class="locked-section"><strong>[LOCK] Advance Plan Required</strong></div></div>
        <?php endif; ?>
        ...
        <?php else: ?><div class="card"><div class="card-header"><h3>Chain Documents</h3></div><div class="locked-section"><strong>[LOCK] Advance Plan Required</strong></div></div><?php endif; ?>
    ...
    <div class="two-col">
      <?php if (is_admin()): ?>
      <div class="card"><div class="card-header"><h3>Add Revenue Village</h3></div><div class="card-body">
      ...
      <?php endif; ?>
      <div class="card"><div class="card-header"><h3>All Revenue Villages</h3><span class="badge badge-blue"><?= count($villages) ?></span></div>
    ...
    <div class="card">
      <div class="card-header"><h3>DLC Records <span style="font-size:.75rem;color:var(--t3);font-weight:400">— FY: <?= e($filterFy?:'All') ?></span></h3><span class="badge badge-blue"><?= count($dlcList) ?></span></div>
        ...
        <div style="background:var(--gold-bg);border:1px solid #d4b090;border-radius:var(--r);padding:12px 14px">
          <div style="display:flex;align-items:flex-start;gap:10px;flex-wrap:wrap">
            <div style="flex:1;min-width:180px">
              ...
              <div style="margin-top:6px;display:flex;gap:5px"><?php if ($dp['file_path']): ?><a href="<?= e($dp['file_path']) ?>" target="_blank" class="btn btn-ghost btn-sm">View Plan</a><?php endif; ?><?php if ($dp['approved_map_path']): ?><a href="<?= e($dp['approved_map_path']) ?>" target="_blank" class="btn btn-ghost btn-sm">View Map</a><?php endif; ?></div>
            </div>
            ...
            <tr>
              ...
              <td>
                <div style="display:flex;gap:5px;flex-wrap:wrap">
                  <a href="index.php?page=view&id=<?= $dp['id'] ?>" class="btn btn-primary btn-sm">View</a>
                  ...
                  <form method="POST" onsubmit="return confirm('Delete?')"><input type="hidden" name="action" value="delete_plan"><input type="hidden" name="plan_id" value="<?= $dp['id'] ?>"><input type="hidden" name="csrf_token" value="<?= e($csrfTok) ?>"><button type="submit" class="btn btn-danger btn-sm">Del</button></form>
                </div>
              </td>
            </tr>
            <?php endforeach; ?>
    ...
    <div style="display:grid;grid-template-columns:1fr 1.6fr;gap:1.2rem">
      <div style="display:flex;flex-direction:column;gap:1.1rem">
        <div class="card"><div class="card-header"><h3>Create User Account</h3></div><div class="card-body">
        ...
        <div class="card"><div class="card-header"><h3>Assign Subscription</h3></div><div class="card-body">
        ...
        <div class="card"><div class="card-header"><h3>Pricing Reference</h3></div><div class="card-body">
          <table style="width:100%;border-collapse:collapse">
      ...
      <div style="display:flex;flex-direction:column;gap:1.1rem">
        <div class="card"><div class="card-header"><h3>All Users</h3><span class="badge badge-blue"><?= count($allUsers) ?></span></div>
        ...
        <div class="card"><div class="card-header"><h3>Subscription History</h3><span class="badge badge-blue"><?= count($allSubs) ?></span></div>
          ...
          <?php else: ?><div class="table-wrap"><table>
            ...
            <tbody><?php foreach ($allSubs as $sub): $isExp=strtotime($sub['end_date'])<time(); $act=$sub['is_active']&&!$isExp; ?>
              ...
              <form method="POST" style="display:inline" onsubmit="return confirm('Delete?')"><input type="hidden" name="action" value="delete_subscription"><input type="hidden" name="sub_id" value="<?= $sub['id'] ?>"><input type="hidden" name="csrf_token" value="<?= e($csrfTok) ?>"><button type="submit" class="btn btn-danger btn-sm">Del</button></form></td></tr>
            <?php endforeach; ?></tbody>
          </table></div><?php endif; ?>
        </div>
      </div>
      ...
      <div class="card-body" style="padding-bottom:.5rem">
        ...
        <form method="POST" action="index.php">
          ...
          <div style="margin-top:1rem;display:flex;gap:9px">
            <button type="submit" class="btn btn-primary btn-md">Save Permissions</button>
            <a href="index.php" class="btn btn-ghost btn-md">Cancel</a>
          </div>
        </form>
      </div>
    ...
    <form method="POST" action="index.php">
      ...
      <!-- Marquee -->
      <div class="card" style="margin-bottom:1.1rem">
        <div class="card-header"><h3>Scrolling Announcement (Marquee)</h3></div>
        <div class="card-body">
      ...
      <!-- Footer -->
      <div class="card" style="margin-bottom:1.1rem">
        <div class="card-header"><h3>Footer Text</h3></div>
        <div class="card-body">
      ...
      <!-- Email -->
      <div class="card" style="margin-bottom:1.1rem">
        <div class="card-header"><h3>Email Configuration (SMTP)</h3></div>
        <div class="card-body">
          <div class="form-grid">
      ...
      <!-- Theme -->
      <div class="card" style="margin-bottom:1.1rem">
        <div class="card-header"><h3>Color Theme Customization</h3></div>
        <div class="card-body">
          ...
          <div style="margin-top:.8rem;display:flex;gap:9px;flex-wrap:wrap">
            <button type="button" onclick="resetTheme()" class="btn btn-ghost btn-sm">Reset to Default</button>
          </div>
        </div>
      </div>

      <div style="display:flex;gap:9px;flex-wrap:wrap">
        <button type="submit" class="btn btn-primary btn-md">Save All Settings</button>
        <a href="index.php" class="btn btn-ghost btn-md">Cancel</a>
      </div>
    </form>
    ...
    <div class="two-col">
      <div style="display:flex;flex-direction:column;gap:1.1rem">
        <div class="card"><div class="card-header"><h3>Account Info</h3></div><div class="card-body">
      ...
      <div style="display:flex;flex-direction:column;gap:1.1rem">
        <div class="card"><div class="card-header"><h3>My Subscription</h3></div><div class="card-body">
          <?php if ($mySub): ?>
        ...
        <div class="card"><div class="card-header"><h3>My Upgrade Requests</h3></div><div class="card-body" style="display:flex;flex-direction:column;gap:7px">
